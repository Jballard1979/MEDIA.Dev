...
#-- Author:   JBALLARD (JEB)                                                                                    :
#-- Date:     2023.2.18                                                                                         :
#-- Script:   IMAGE.WATERMARK.py                                                                                 :
#-- Purpose:  A python script that add a wathermark on images.                                                  :
#-- Version:  1.0                                                                                               :
#-- ************************************************************************************************************:
#-- ************************************************************************************************************:
#--
...
def watermark_photo(input_image_path,watermark_image_path,output_image_path):
    ...
    #-- INJECT WATERMARK ONTO DESIRED IMAGE FILE:
    ...
    #-- GENERATE NEW TRANSPARENT IMAGE:
    transparent = Image.new(mode='RGBA',size=position,color=(0,0,0,0))
    #-- PASTE ORIGINAL IMAGE FILE:
    transparent.paste(base_image,(0,0))
    #-- PASTE WATERMARKED IMAGE:
